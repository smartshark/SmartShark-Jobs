 ...
 * Optimized Approach which finds duplicate developers from the people collection
 * Decision Tree is used as a Machine Learning Algorithm
...
object algorithm3 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    /*
     * Part of data is saved as a csv file and labelled manually as true,false, and uncertain
     */      
     ...
     * as features for the machine learning algorithm
     */ 
     ...
     */
    val splits = my_df.randomSplit(Array(0.67, 0.33), seed = 90891)
    val (trainingData, testData) = (splits(0), splits(1))

    /*
     * Decision Tree is used for multi-label classification 
     */
